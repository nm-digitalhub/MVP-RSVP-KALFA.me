    ...
    <article class="overflow-hidden px-3 py-2 transition {{ $rowTone }}">
        <div class="flex items-start gap-3">
            ...
            <div class="hidden items-center rounded-xl border border-slate-200/90 bg-slate-50/90 p-1 shadow-xs md:flex md:opacity-0 md:transition-all md:group-hover:opacity-100 md:group-focus-within:opacity-100">
                ...
                <button type="button" wire:click="requestToggle" class="inline-flex min-h-8 min-w-8 cursor-pointer items-center justify-center rounded-lg text-slate-400 transition hover:bg-white hover:text-slate-700">
                    <x-heroicon-o-power class="size-4" />
                </button>

                <span class="h-5 w-px bg-slate-200"></span>

                <button type="button" wire:click="requestDelete" class="inline-flex min-h-8 min-w-8 cursor-pointer items-center justify-center rounded-lg text-rose-500 transition hover:bg-white hover:text-rose-700">
