@props([
    ...
    'identifier'   => null,
    'status'       => 'active',
    'type'         => 'task', // task, requirement, doc, folder
    'description'  => '',     // תיאור עבור הפופ-אובר
    'lastComment'  => null,   // אובייקט עם user_name, time, text, avatar
    'meta'         => [],
    'draggable'    => false,
    'isActive'     => false,  // האם השורה נבחרה כרגע
])
...
>
    ...
    >
        ...
        <div x-show="actionsOpen" x-transition.opacity class="flex items-center gap-1 shrink-0">
             <button type="button" class="p-1 hover:bg-black/10 dark:hover:bg-white/10 rounded transition">
