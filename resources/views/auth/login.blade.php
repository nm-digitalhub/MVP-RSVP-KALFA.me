    ...
    <div class="auth-shell">
        <div class="auth-card">
            <div class="auth-card-header">
                <div class="auth-kicker">כניסה מאובטחת</div>
            <x-auth-logo />
            <h2 class="auth-title">
                {{ __('auth.sign_in') }}
            </h2>
            ...
            @if(session('url.intended') && str_contains(session('url.intended'), 'esim'))
                <div class="auth-status auth-status-info mt-4 text-center">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input id="email" name="email" type="email" autocomplete="username webauthn" required 
                           value="{{ old('email') }}"
                           class="auth-input @error('email') border-red-400 focus:border-red-400 focus:ring-red-100 @enderror" 
                ...
                <div class="relative">
                    ...
                    <input id="password" name="password" type="password" autocomplete="current-password" required 
                           class="auth-input pe-12 @error('password') border-red-400 focus:border-red-400 focus:ring-red-100 @enderror" 
            ...
            <div class="flex items-center justify-between gap-4 flex-wrap">
                <div class="flex items-center">
                    <input id="remember" name="remember" type="checkbox" 
                           class="auth-checkbox">
                    <label for="remember" class="me-2 block text-sm text-content">
                        {{ __('auth.remember_me') }}
                    </label>
                </div>
        ...
        <div class="mt-4">
            ...
            <p class="mt-2 text-center text-xs text-content-muted">{{ __('auth.passkey_hint') }}</p>
