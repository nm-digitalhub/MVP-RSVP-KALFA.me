            ...
            <div class="space-y-4 bg-gray-50 p-4 rounded-lg">
                ...
                <div class="flex items-start">
                    ...
                    <label for="terms" class="me-2 block text-sm text-gray-900">
                        אני מסכים ל<a href="{{ route('terms') }}" class="text-indigo-600 hover:text-indigo-500 underline" target="_blank">תנאי השימוש</a>,
                        <a href="{{ route('privacy') }}" class="text-indigo-600 hover:text-indigo-500 underline" target="_blank">מדיניות הפרטיות</a> ו<a href="{{ route('refund.policy') }}" class="text-indigo-600 hover:text-indigo-500 underline" target="_blank">מדיניות ביטולים והחזרות</a> *
                    </label>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <label for="data_processing" class="me-2 block text-sm text-gray-900">
                        אני מסכים לעיבוד הנתונים האישיים שלי למטרות מתן השירות, תמיכה טכנית וחיוב עפ"י <a href="{{ route('privacy') }}" class="text-indigo-600 hover:text-indigo-500 underline" target="_blank">מדיניות הפרטיות</a> *
                    </label>
                </div>
