...
These logical agents are used by ACP Dispatch to route work to the right "brain" inside this Laravel app. Each agent has a clear domain and must focus only on its scope.

### kalfa-laravel-core

**Responsibility:** Core Laravel backend (HTTP, models, services, policies, console).
...
**Responsibility:** Application UI built with Livewire, Blade and Tailwind.

**Scope:**
- `app/Livewire/**`
- `resources/views/**`
- `resources/js/**`
- `resources/css/**` and Tailwind config
...
**Responsibility:** Billing, checkout and payment gateway flows.

**Scope:**
- `app/Livewire/Billing/**`
- `app/Livewire/Checkout/**`
- Payment-related services and contracts under `app/Services/**` and `app/Contracts/**`
- Any payment webhooks/controllers under `app/Http/Controllers/**`
...
### kalfa-domain-appointments

**Responsibility:** Appointments scheduling and related flows.

**Scope:**
- `app/Livewire/Appointments/**`
- Appointment-related models, requests and services under `app/Models/**`, `app/Http/Requests/**`, `app/Services/**`
...
### kalfa-domain-organizations-admin

**Responsibility:** System / organization administration: users, accounts, organizations.

**Scope:**
- `app/Livewire/Organizations/**`
- `app/Livewire/System/Users/**`
- `app/Livewire/System/Accounts/**`
- `app/Livewire/System/Organizations/**`
- Related models and policies under `app/Models/**`, `app/Policies/**`
...
### kalfa-auth-profile-registration

**Responsibility:** Authentication, login, profile and registration flows.

**Scope:**
- `app/Livewire/Login/**`
- `app/Livewire/Profile/**`
- `app/Livewire/Registration/**`
- Auth-related guards and middleware under `app/Guards/**`, `app/Http/Middleware/**`
