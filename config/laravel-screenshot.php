...
return [
    ...
    'browsershot' => [
        ...
        /*
         * Chromium refuses to start as root without --no-sandbox (Linux).
         * Default: true when effective UID is 0 (POSIX); override with LARAVEL_SCREENSHOT_NO_SANDBOX.
         */
        'no_sandbox' => ($noSandboxEnv = env('LARAVEL_SCREENSHOT_NO_SANDBOX')) === null
            ? (function_exists('posix_geteuid') && posix_geteuid() === 0)
            : filter_var($noSandboxEnv, FILTER_VALIDATE_BOOLEAN),
    ],
