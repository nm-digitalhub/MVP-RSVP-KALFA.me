...
return [
    ...
    */
    'routes' => [
        ...
        // Route name for client login (checkout/check-email flow). MVP-RSVP: use app login route.
    ...
    |--------------------------------------------------------------------------
    | Route names for notification links. Set to your app route names when used.
    | Omit or null = link not shown. No Filament route names.
    |
    */
    'notification_routes' => [
