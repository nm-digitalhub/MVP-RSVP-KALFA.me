...
- [[Architecture/Auth]] — Authentication methods and middleware chain
- [[Architecture/Services/OrganizationContext]] — How org context is set for Spatie team
- [[Architecture/Glossary]] — Role and permission term definitions
- [[Architecture/Diagrams/06-Auth-Flow]] — Visual middleware chain diagram
