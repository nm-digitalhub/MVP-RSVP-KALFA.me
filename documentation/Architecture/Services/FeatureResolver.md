...
- [[Architecture/Services/SubscriptionService]] — Triggers cache invalidation on every state transition
- [[Architecture/Services/UsagePolicyService]] — Uses FeatureResolver for limit lookups
- [[Architecture/Caching]] — Feature cache layer details (Cache::memo, Redis, TTL, invalidation)
...
- [[Architecture/AsyncQueue]] — ProductEngineEvent + LogProductEngineEvent listener
- [[Architecture/Glossary]] — Feature Key, Priority Chain, Cache Key definitions
- [[Architecture/Database/Schema]] — ProductFeature, AccountEntitlement, AccountFeatureUsage tables
